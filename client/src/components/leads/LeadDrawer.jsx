              ...
              <>
                ...
                {lead.phone && (
                  <div className="flex items-center gap-1.5 ml-1">
                    <a
                      href={`tel:${lead.phone}`}
                      className="p-1.5 rounded-full text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors flex items-center justify-center border border-blue-200"
                    ...
                    <a
                      ...
                      className="p-1.5 rounded-full text-green-600 bg-green-50 hover:bg-green-100 transition-colors flex items-center justify-center border border-green-200"
