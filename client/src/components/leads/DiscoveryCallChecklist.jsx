...
export default function DiscoveryCallChecklist({ lead, onUpdate }) {
  ...
  return (
    <div className="rounded-xl border p-4 shadow-sm mb-4 transition-all" style={{ background: 'rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.4)' }}>
