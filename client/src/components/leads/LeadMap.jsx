...
export default function LeadMap({ leads, onLeadClick }) {
  ...
  return (
    <div className="rounded-xl shadow-sm h-full flex flex-col relative overflow-hidden min-h-[600px]" style={{ background: 'rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(255, 255, 255, 0.4)', boxShadow: '0 10px 30px -10px rgba(0, 0, 0, 0.05)' }}>
      {/* Mock Map Background */}
      <div 
      ...
      <div className="p-5 border-b z-10 flex justify-between items-center" style={{ background: 'rgba(255, 255, 255, 0.4)', backdropFilter: 'blur(10px)', borderBottom: '1px solid rgba(255, 255, 255, 0.3)' }}>
        <div>
      ...
      <div className="relative flex-1 p-6 z-10">
        ...
        {leadsWithLocation.length === 0 ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
            <div className="w-16 h-16 mb-4 rounded-full bg-blue-50 text-blue-400 flex items-center justify-center shadow-lg">
          ...
          leadsWithLocation.map(lead => {
            ...
            return (
              ...
              >
                <div className="absolute top-5 left-1/2 -translate-x-1/2 text-[10px] px-2 py-1 rounded opacity-0 hover:opacity-100 whitespace-nowrap pointer-events-none transition-opacity" style={{ background: 'var(--color-text)', color: 'var(--color-surface)', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
