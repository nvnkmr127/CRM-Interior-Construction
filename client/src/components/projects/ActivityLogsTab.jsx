...
const Icons = {
  ...
  system: () => <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
};
...
export default function ActivityLogsTab({ projectId, onTaskAdded }) {
  ...
  const handleDeleteActivity = async (activityId) => {
    ...
    try {
      const res = await api.delete(`/projects/${projectId}/activities/${activityId}`);
                      ...
                      {!isSystem && editingActivityId !== activity.id && (
                        <div className="flex items-center ml-2 shrink-0">
                          ...
                          <button
                            ...
                            className="p-1 hover:bg-gray-100 rounded text-gray-400 hover:text-red-600 transition-colors ml-1"
